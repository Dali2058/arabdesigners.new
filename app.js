...
function badgeList(d){
  ...
  if(username===OWNER_USERNAME.toLowerCase()){ list.push('owner','staff'); }
...
async function home(){
  ...
  <section class="section home-marquee" aria-label="Platform highlights"><div class="marquee-track"><span>IDENTITY</span><i>✦</i><span>UI / UX</span><i>✦</i><span>ART DIRECTION</span><i>✦</i><span>MOTION</span><i>✦</i><span>3D</span><i>✦</i><span>IDENTITY</span><i>✦</i><span>UI / UX</span><i>✦</i><span>ART DIRECTION</span></div></section>
