...
function about(){
  shell(`<section class="about-hero about-hero-v2 about-hero-premium"><div><div class="section-label">ABOUT · ARAB DESIGNERS</div><h1>Design with<br><span>direction.</span></h1><p>Arab Designers is a focused creative network for designers, visual thinkers and people who care about the details behind the work.</p><div class="about-actions"><a class="btn primary" href="/designers">Meet the designers ↗</a><a class="text-link" href="/contact">Start a project →</a></div><div class="about-signature"><span>CREATIVE NETWORK</span><span>VISUAL IDENTITY</span><span>UI/UX</span><span>DIRECTION</span></div></div><div class="about-portrait about-portrait-v2 about-orbit-card"><img src="${EYAD}" alt="Arab Designers"><div class="portrait-overlay"></div><div class="portrait-tag">Eyad The Founder<br><small>Started in 2012 · Recognized in 2024</small></div><span class="orbit orbit-one"></span><span class="orbit orbit-two"></span></div></section>
